...
## 1. 프로젝트 개요 및 용도
**프로젝트 목적:** 유니티 6 엔진의 2D 기능과 효율적인 깃(Git) 브랜치 병합 프로세스를 이해하고 협업에 적용하기 위한 과제 프로젝트입니다.<br/>
**주요 기능:**
...
**Target Platforms:** Windows (`.exe`), Linux(`Executable`)
...
현재 release 탭에서 Windows, Linux 환경을 지원하는 실행 파일이 존재하며, Main Build.zip 파일을 다운받아 압축 해제하고, opensourceSW.exe 파일을 실행하면 프로젝트 실행 가능합니다.
